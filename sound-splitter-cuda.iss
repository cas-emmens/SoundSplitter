...
OutputDir=dist
OutputBaseFilename=SoundSplitter-Setup-{#AppVersion}-cuda
...
Source: "src-tauri\payload-cuda\*"; DestDir: "{app}\payload"; Flags: ignoreversion recursesubdirs createallsubdirs
